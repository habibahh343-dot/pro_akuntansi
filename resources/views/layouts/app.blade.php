...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark" style="background: linear-gradient(90deg, #0f172a, #1e3a8a);">
        <div class="container">
            <a class="navbar-brand" href="{{ url('/home') }}">Akuntansi</a>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('jurnal.index') }}">Jurnal Umum</a></li>
                            <li><a class="dropdown-item" href="{{ route('jurnal_detail.index') }}">Jurnal Detail</a></li>
                            <li><a class="dropdown-item" href="{{ route('faktur_penjualan.index') }}">Faktur Penjualan</a></li>
                            <li><a class="dropdown-item" href="{{ route('faktur_pembelian.index') }}">Faktur Pembelian</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('perkiraan.index') }}">Perkiraan</a></li>
                            <li><a class="dropdown-item" href="{{ route('saldo_akun.index') }}">Saldo Akun</a></li>
                            <li><a class="dropdown-item" href="{{ route('pelanggan.index') }}">Pelanggan</a></li>
                            <li><a class="dropdown-item" href="{{ route('pemasok.index') }}">Pemasok</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('buku_besar.index') }}">Buku Besar</a></li>
                            <li><a class="dropdown-item" href="{{ route('neraca_saldo.index') }}">Neraca Saldo</a></li>
                            <li><a class="dropdown-item" href="{{ route('laporan_keuangan.index') }}">Laporan Keuangan</a></li>
                        </ul>
                    </li>
