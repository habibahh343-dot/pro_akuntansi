...
// Route resource TANPA auth (bisa diakses tanpa login)
...
// Alias untuk typo di navbar (bubu_besar -> buku_besar, faktur_pembelian tanpa .index)
Route::get('/bubu_besar', [App\Http\Controllers\BukuBesarController::class, 'index'])->name('bubu_besar.index');

// Reset transaksi
Route::post('/transaksi/reset', function () {
    return back()->with('success', 'Data transaksi berhasil dikosongkan');
